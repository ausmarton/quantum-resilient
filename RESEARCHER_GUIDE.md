...
**Important:** Destroy cluster after experiments to avoid costs:
```bash
cd terraform/gke
terraform destroy -var="project_id=<your-project>" -var="bucket_name=<your-bucket>"
cd ../..
```
...
2. **Destroy GCP clusters immediately** after experiments
...
./deploy_gcp.sh --scenario scenarios/hybrid_kyber_dilithium.yaml --exp-id smoketest --smoke-test --project <p> --bucket <b>
