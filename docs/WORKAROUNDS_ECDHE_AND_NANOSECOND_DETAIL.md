...
**Conclusion**: The nanosecond workaround was **necessary** because integer microsecond storage **truncated** sub-μs latencies to 0, corrupting a large share of the data and invalidating the latency comparisons and statistics the dissertation relies on.
