...
3. **`build_final_report.py`**: Generate report-ready PDF reports with executive summary, figures, tables, and interpretive paragraphs
...
10. **`export_dataset.py`**: Export dataset (CSV, Parquet, Markdown tables) (CSV, Parquet, Markdown tables)
...
6. **Reporting**: Generate report-ready reports
...
5. **Reporting**: Generate report-ready reports
