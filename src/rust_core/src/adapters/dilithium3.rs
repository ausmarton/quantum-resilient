...
impl CryptoAdapter for Dilithium3 {
	fn name(&self) -> &str { "Dilithium3" }

	fn public_key_size(&self) -> usize { 1952 }
	fn secret_key_size(&self) -> usize { 4000 }
	fn signature_size(&self) -> usize { 3293 }
