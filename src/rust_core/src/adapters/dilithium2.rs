...
impl CryptoAdapter for Dilithium2 {
	fn name(&self) -> &str { "Dilithium2" }

	fn public_key_size(&self) -> usize { 1312 }
	fn secret_key_size(&self) -> usize { 2528 }
	fn signature_size(&self) -> usize { 2420 }
